    ...
    return (
        <div className="mx-auto max-w-6xl px-2 sm:px-4 md:px-6">
            ...
            <Modal
                ...
                className="max-w-[95vw] p-0 sm:max-w-md"
            >
            ...
            <div className="grid gap-4 rounded-xl bg-white p-2 sm:gap-6 sm:p-6 lg:grid-cols-2">
                ...
                <Card className="w-full min-w-0 border-[#755ae2] p-0 shadow-none sm:min-w-[320px] lg:col-span-1">
                    <div
                        className="relative flex aspect-video h-full min-h-[200px] items-center justify-center overflow-hidden rounded-lg bg-gray-900 sm:min-h-[300px]">
                        {capturedImage ? (
                            // Show captured image
                            ...
                            <>
                                ...
                                {!webcamReady && (
                                    <div
                                        className="bg-opacity-75 absolute inset-0 flex items-center justify-center bg-gray-900">
                                        <div className="text-center text-white">
                                            <div
                                                className="mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-4 border-white border-t-transparent sm:h-12 sm:w-12"></div>
                                ...
                                {recordingStatus === 'countdown' && (
                                    <div
                                        ...
                                        <div className="text-center text-white">
                                            <div
                                                className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-white/20 sm:h-24 sm:w-24">
                          ...
                          {countdownValue}
                            ...
                            <div className="flex h-full w-full items-center justify-center text-white">
                                <div className="text-center">
                                    <div
                                        className="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-white/20 sm:mb-4 sm:h-16 sm:w-16">
